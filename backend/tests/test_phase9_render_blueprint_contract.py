...
class Phase9RenderBlueprintContractTests(unittest.TestCase):
    def test_render_yaml_declares_required_api_environment(self) -> None:
        ...
        required_fragments = [
            ...
            "- key: MEDIA_STORAGE_BUCKET",
            "- key: MEDIA_STORAGE_PROJECT_URL",
            "- key: MEDIA_STORAGE_PUBLIC_BASE_URL",
            "- key: MEDIA_STORAGE_SERVICE_ROLE_KEY",
            "- key: DATABASE_URL",
            "- key: JWT_SECRET",
            "- key: SECRET_KEY",
    ...
    def test_backend_env_example_matches_production_bootstrap_requirements(self) -> None:
        ...
        required_assignments = [
            ...
            "MEDIA_STORAGE_BACKEND=supabase_storage",
            "MEDIA_STORAGE_BUCKET=restaurants-media",
            "MEDIA_STORAGE_PROJECT_URL=https://your-project-ref.supabase.co",
            "MEDIA_STORAGE_PUBLIC_BASE_URL=https://your-project-ref.supabase.co/storage/v1/object/public/restaurants-media",
            "MEDIA_STORAGE_SERVICE_ROLE_KEY=replace_with_service_role_key",
