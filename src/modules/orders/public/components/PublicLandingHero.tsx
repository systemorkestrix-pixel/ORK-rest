...
export function PublicLandingHero({
  ...
  return (
    <section className="overflow-hidden rounded-[34px] border border-[#eadbc7] bg-[radial-gradient(circle_at_top_right,rgba(232,166,89,0.18),transparent_30%),linear-gradient(180deg,#fffaf3_0%,#f7ede0_100%)] p-5 shadow-[0_26px_64px_rgba(170,126,70,0.14)] md:p-7">
        ...
        <div className="flex flex-col justify-between gap-5">
          <div className="space-y-4">
            <div className="inline-flex w-fit items-center gap-3 rounded-full border border-[#eadbc7] bg-white/85 px-4 py-2">
              <span className="rounded-full bg-[#e38b38] px-2.5 py-1 text-xs font-black uppercase tracking-[0.24em] text-[#1a120d]">
                {brandMark}
              </span>
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#fff2df] text-[#cf7f2a]">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to={scopedTrackPath}
              className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-2xl bg-[#e38b38] px-5 text-sm font-black text-[#1a120d] transition hover:bg-[#ef9a4b]"
            >
            ...
            {hasTableContext ? (
              <span className="inline-flex min-h-[48px] items-center rounded-2xl border border-sky-300 bg-sky-50 px-4 text-xs font-black text-sky-700">
